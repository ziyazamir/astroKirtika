                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h5></h5>
                                <a href="{{ url('offers/create') }}" class="btn btn-success">Add offers</a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="table-responsive">
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($topAstrologerSelections as $topAstrologerSelection)
                                            <tr>
                                                <td>{{ $loop->index + 1 }}</td>
                                                <td>{{ $topAstrologerSelection->from_date }}</td>
                                                <td>{{ $topAstrologerSelection->to_date }}</td>
                                                <td>
                                                    {{ $topAstrologerSelection->name }}
                                                </td>
                                                {{-- <td>
                                                    <a href="{{ url('topastro/edit/' . $topAstrologerSelection->id) }}"
                                                        class="btn btn-primary btn-sm">Edit</a>
                                                    <a href="{{ url('topastro/delete/' . $topAstrologerSelection->id) }}"
