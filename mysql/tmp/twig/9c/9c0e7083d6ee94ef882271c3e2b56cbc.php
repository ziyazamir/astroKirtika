...
echo _gettext("Continue");
    ...
    {
        return new Source("", "database/structure/bulk_action_modal.twig", "/home2/webardkl/astrokirtika.royindfuture.com/mysql/templates/database/structure/bulk_action_modal.twig");
    }
}
